              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="border-l-4 border-l-primary rounded-lg p-4 bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Implement human oversight for high-risk decisions and sensitive use cases to catch edge cases and
                      errors.
                    </p>
                  </div>
                  <div className="border-l-4 border-l-primary rounded-lg p-4 bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Enforce strict authentication, audit logging, and real-time monitoring to track usage patterns and
                      detect anomalies.
                    </p>
                  </div>
                </div>
